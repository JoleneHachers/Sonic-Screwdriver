...
void setup() {
  strip.begin();
  strip.setBrightness(1);       //set brightness here
  strip.show(); // Initialize all pixels to 'off'
}
 
void loop() {
flashRandom(20, 50);  // first number is 'wait' delay, shorter num == shorter twinkle //change the first number to change the speed
