//this scrips is a back and forth eco skan where you can individual set the forard colour and reverce color and the echo colour
...
#define TPIXEL 8 //The total amount of pixel's/led's in your connected strip/stick (Default is 60)
...
void loop() {
  ...
  CylonEyeDown(strip.Color(0,0,175), strip.Color(25,25,25), strip.Color(0,10,10), wait_T, PixelCount, Pixel_Start_End);
  delay(wait_T);
}
